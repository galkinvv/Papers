...
Заметим, что в отличии от алгоритма F5, описанного в {[}1{]},
...
в {[}2{]} как ``monoid ideal''. Рассмотрим следующие
...
отбрасывания некоторых вычислений -- описывается в {[}7,8,9{]}
...
{[}10,11{]} позволяет добиться большей эффективности
...
из авторов {[}8{]}) по реализации F5-подобных алгоритмов
