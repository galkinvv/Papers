...
Заметим, что в отличии от алгоритма F5, описанного в {[}1{]}, однородность
...
Иначе можно домножить неравенство (1) на ненулевой
...
или $\succ_{0}$ левой или $\prec_{0}$ правой части неравенства (2),
...
в {[}2{]} как ``monoid ideal''. Рассмотрим следующие множества, являющиеся
идеалами моноидов: $L_{*0}=\left(\left\{ \sigma\,|\,(\sigma,0)\in R_{*0}\right\} \right)\subset\mathbb{T}$
