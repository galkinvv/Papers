...
Lei Huang в статье \flqq{}A new conception for computing gr\"{o}bner
basis and its applications\frqq{}, депонированной на \href{http://arxiv.org/abs/1012.5425v2}{http://arxiv.org/abs/1012.5425v2}.
...
S-полиномов до проведения редукции и вводит специальный критерий \flqq{}super-topreducible\frqq{}
...
которые не смогут удовлетворять определённому в работе критерию \flqq{}primitve
S-irreducble\frqq{} после редукции. Эти методики позволяют ускорить
...
домножения всего многочлена на моном. Таким образом, для отброшенных
